/******************************************************************************
 * @file    environment_x6_sensor.c
 * @brief   iNose X6 gas sensor module UART driver implementation
 * @author  Waveshare
 * @license BSD-3-Clause / Waveshare Open Source
 ******************************************************************************/

#include "environment_x6_sensor.h"
#include <string.h>

#if defined (__AVR_ATmega328P__)
SoftwareSerial ENVIRONMENTX6_SERIAL(ENVIRONMENTX6_RX, ENVIRONMENTX6_TX); //Specify the software serial port pin 指定软件串口的引脚
#endif
